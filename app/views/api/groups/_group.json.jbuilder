...
json.event_type group.event_type
# json.event_id group.event_id
json.group_event_id group.group_event_id
json.users group.users
json.user_images group.user_images
json.group_event_category group.find_category
json.group_event group.group_events
json.group_invites_emails group.find_invites_emails
json.group_invites_all group.invites
json.group_image group.group_image